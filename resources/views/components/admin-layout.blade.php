...
<body>
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="admin-sidebar-nav">
            ...
            <a href="{{ route('admin.reviews') }}" class="admin-sidebar-link {{ request()->routeIs('admin.reviews') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.907c.961 0 1.36 1.242.588 1.81l-3.97 2.883a1 1 0 00-.364 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.97-2.883a1 1 0 00-1.176 0l-3.97 2.883c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.364-1.118l-3.97-2.883c-.773-.568-.375-1.81.588-1.81h4.907a1 1 0 00.95-.69l1.519-4.674z"/></svg>
                Reseñas
            </a>
